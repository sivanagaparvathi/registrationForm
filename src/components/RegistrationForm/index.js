...
class RegistrationForm extends Component {
  ...
  renderSubmissionSuccessVew=()=>(
      ...
      onClick={this.onClickSubmitAnotherResponse}>Submit Another Response</button>
      </>
  )
  render(){
      const {isValidFirstName}=this.state

      return(
          <div className="registration-form-container">
              <h1 className="form-title">Registration</h1>
              <div className="view-container">
                  {isFormSubmitted?this.renderSubmissionSuccessVew():this.renderRegistrationForm()}
              </div>
          </div>
      )
  }
